...
//      Edit By Akkarapol,28/08/2013, เนื่องจากบน HOST เป็น PHP 5.5.x แล้ว ทำให้ ฟังก์ชั่น preg_replace ใช้ไม่ได้ เลยต้องคอมเม้นต์ทิ้งไปก่อน 
//	$str = preg_replace('/\&\#([0-9]+)\;/me', "code2utf('\\1',{$lo})",$str);
//	$str = preg_replace('/\&\#x([0-9a-fA-F]+)\;/me', "codeHex2utf('\\1',{$lo})",$str);
//      END Edit By Akkarapol,28/08/2013, เนื่องจากบน HOST เป็น PHP 5.5.x แล้ว ทำให้ ฟังก์ชั่น preg_replace ใช้ไม่ได้ เลยต้องคอมเม้นต์ทิ้งไปก่อน           
	return $str;
  }
}

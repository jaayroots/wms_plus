...
class report_R_to_R_Inventory_movement extends CI_Controller {
	...
	*/
    function importForm() {
        ...
        $str_form = $this->parser->parse("form/import_Inventory_movement", $parameter, TRUE);

        $this->parser->parse('workflow_template', array(
            'state_name' => 'import_Inventory_movement'

...
<script>
    ...
    function exportFile(file_type) {
        if (file_type == 'EXCEL') {
            $("#form_report").attr('action', "<?php echo site_url(); ?>" + "/report/exportExcelMovementAll")
        } else {
            $("#form_report").attr('action', "<?php echo site_url(); ?>" + "/report/exportReportStockMovementAllProductPDF")
        }
        $("#form_report").submit();
    }
</script>
                ...
                foreach ($datas as $keyProduct => $data) {
                    foreach ($data as $key => $values) {
                        ...
                        foreach ($values as $value) {
                            ?>
                            <tr>
                                <td><?php echo $keyProduct ?> / <?php echo $value['Product_NameEN']; ?></td>
                                <td ><?php echo $i; ?></td>
                        ...
                        ?>
                            <tr>
                                <td class ="sum_group"><?php echo $keyProduct ?> / <?php echo $value['Product_NameEN']; ?></td>

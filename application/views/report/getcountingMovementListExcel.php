...
if(count($header) > 0 ){
	foreach ($header as $head) {
		...
		foreach($data as $key => $aColumns){
      $no = $key+1;
      echo  '<tr>';
        echo  '<td><font face=\"Tahoma\" size=2>'.$no.'</font></td>'; 
        echo  '<td><font face=\"Tahoma\" size=2>'.$aColumns->Room.'</font></td>'; 
        echo  '<td><font face=\"Tahoma\" size=2>'.$aColumns->Row.'</font></td>'; 
        echo  '<td><font face=\"Tahoma\" size=2>'.$aColumns->Colunm.'</font></td>'; 
        echo  '<td><font face=\"Tahoma\" size=2>'.$aColumns->Level.'</font></td>'; 
        echo  '<td><font face=\"Tahoma\" size=2>'.$aColumns->Location_Code.'</font></td>'; 
        echo  '<td><font face=\"Tahoma\" size=2>'.$aColumns->Pallet_Code.'</font></td>'; 
      echo  '</tr>';
  //                   $td_pallet_code = '';
  //                   $td_container = '';
  //                   $td_invoice_no = '';

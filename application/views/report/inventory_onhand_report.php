...
*/
    ...
    function exportFile(file_type) {
        if (file_type == 'EXCEL') {
            $("#form_report").attr('action', "<?php echo site_url(); ?>" + "/report/inventory_onhand_toexcel")
        } 
        $("#form_report").submit();
    }
            ...
            <div class="dataTables_filter" id="defDataTable2_filter">
                ...
                <table class ='well table_report' cellpadding="0" cellspacing="0" border="0" aria-describedby="defDataTable_info" style="max-width: none">
                    ...
                    <tbody>
                        ...
                        if (empty($data)):
                            echo "<tr><td colspan='16' align='center'><b>No Data Available.</b></td></tr>";
                        else:
                            foreach ($data as $key => $value) {
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:left;width:100px;"><?php echo $value->Doc_Refer_Int ?></td>
                                </tr>
                                <?php
                                $sum_balance+= $value->remain;

    ...
    <tr>
        ...
        <td style="text-align: center; font-weight: bold;">
            <table style="text-align: center; font-weight: bold;">
                <tr><td style="text-align: center; font-weight: bold;">' . iconv("TIS-620", "UTF-8", ' DAMAGED REPORT') . '</td></tr>
                <!--<tr><td style="text-align: center; font-weight: bold;">รายงานสินค้าไม่ตรงตามข้อกำหนด</td></tr>-->
            </table>
        </td>
        <td width="200"> </td>
    </tr>
...
<thead>
    <tr style="border:1px solid #333333;" bgcolor="#B0C4DE">
        ...
        <th width="25%">Damaged Cargo Description</th>
    </tr>
</thead>
<tbody>
    <tr>
...
$page .= '<tr><td colspan="4" height="30">Photo of Damaged Cargo</td></tr>';
$idx = 1;
$all = count($images);
$remain = ($all % 4);

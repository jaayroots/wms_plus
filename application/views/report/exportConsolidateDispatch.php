...
foreach ( $document_list as $idx => $val ) :
    ...
    $document_no .= $val->Document_No . "(" . $order_mapping[$val->Document_No]['State_NameTh'] . "),";
...
$header = '<table width="100%" style="vertical-align: bottom; font-family: arial; font-size: 16px; color: #000000;">
    <tr>
        ...
        <td style="text-align: center;font-weight: bold; font-size: 12pt;">'.iconv("TIS-620","UTF-8", 'Delivery Order Consolidation Report').'</td>
        <td width="300"> </td>
    </tr>
</table>
<table width="100%" align="left" border="0" style="font-size:10pt; font-family: arial; margin-top: 10px;">
    <tr>
        <td>'._lang('document_no') . ' : ' . $document_no . '</td>
    </tr>
</table>';
...
<table width="100%" cellspacing="0" style="font-family: arial;font-size:10px; border-right: 1px solid #333;" class="tborder">
    <thead>
        <tr style="border:1px solid #333333;" bgcolor="#B0C4DE">
            ...
            <div class="serial" width="9%"><th class="serial" width="9%">'._lang('serial').'</th></div>
            ...
            <div class="remark" width="5%"><th class="remark" width="5%">'._lang('remark').'</th></div>
        </tr>
    </thead>
    <tbody>';
    ...
    if(!empty($data)){
        ...
        foreach($data as $idx => $value){
            ...
            if ( $is_start_new != $value['product_code'] && $is_start_new != FALSE) :
                ...
                <td colspan="'.( 2 + $all_column ).'" align="right"><b>Sub Total</b></td>
                <td align="right"><b>'.set_number_format($is_start_sum).'</b></td>
                <td></td>
                <td></td>
                </tr>';
            ...
            $page.='
                <tr style="border-bottom: 3px #000 solid;">
                    <div class="product_code"><td class="product_code" valign="top" align="center">'.$value['product_code'].'</td></div>
                    <div class="product_name"><td  class="product_name" valign="top">'.iconv("TIS-620","UTF-8",$value['product_name']).'</td></div>
                    <div class="lot"><td  class="lot" valign="top" align="center">'.$value['lot'].'</td></div>
                    <div class="serial"><td  class="serial" valign="top" align="center">'.$value['serial'].'</td></div>
                    ...
                    <div class="qty"><td class="qty" valign="top" align="right">'.set_number_format($value['total']).'</td></div>
        ...
        <div><td colspan="'. ( 2 + $all_column ) .'" align="center"><b>Total</b></td></div>
    ...
    $mpdf->WriteHTML($page);
    $filename = 'Delivery-Order-Consolidation-Report-' . date('Ymd') . '-' . date('His') . '.pdf';

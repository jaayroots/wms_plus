		...
		$page.=$head_table;	
		  ...
		  if(!empty($datas)){ //p($datas);exit();
                        ...
                        foreach($datas as $key => $data){  //p($data);exit();
                            ...
                            $page .= '<tr>';
								$page.='<td colspan="2" height="23" valign="top" class="tdData" style="text-align:left"><b>'.$key. " " .iconv("TIS-620","UTF-8",$data["product_name"]).'</b></td>';
                            ...
                            $i=1;
                            foreach ($data['loc'] as $val)://p($val);exit();
                                
                                $page .= '<tr>';
                                    $page.='<td height="23" valign="top" class="tdData" style="text-align:left">'.$i++.'</td>';
                                    $page.='<td valign="top" class="tdData" style="text-align:left">'.$val['location'].'</td>';
//                                    $page.='<td valign="top" class="tdData" style="text-align:left">'.iconv("TIS-620","UTF-8",$val['product_name']).'</td>';
                        ...
                        $page .= '<tr bgcolor="#F5F5F5">
									<td colspan="3" class="tdData"><b>Total Balance</b></td>

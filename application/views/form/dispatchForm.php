                    ...
                    <tr>
                        <td>
                            <div style="width:90%;">
                                ...
                                <input type="text" name="productCode" id="productCode" class="input-medium" placeholder="<?php echo _lang('product_code') ?>">
                                    ...
                                    <table cellpadding="2" cellspacing="0" border="0" class="display" id="ShowDataTableForInsert">
                                        <thead>
                                            <tr>
                                                ...
                                                <td><?php echo _lang('product_status') ?></td>
                                                <td><?php echo _lang('product_license') ?></td>
                                                <td><?php echo _lang('lot') ?></td>
                                                <td><?php echo _lang('serial') ?></td>
                                                <td><?php echo _lang('product_mfd') ?></td>
                                                <td><?php echo _lang('product_exp') ?></td>

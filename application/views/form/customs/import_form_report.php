<script>
    ...
    function show_data_of_page(page,ipp){
        ...
        $.ajax({
            type: 'get',
            url: '<?php echo site_url(); ?>/report_customs/importReportSearch', // in here you should put your query 
            data: 'fdate=' + fdate 
                    + '&tdate=' + tdate 
                    + '&page=' + page 
                    + '&ipp=' + ipp 
...
<TR class="content" style='height:100%' valign="top">
    <TD>
        <form class="<?php echo config_item("css_form"); ?>" method="POST" action="" id="frmImportReport" name="frmImportReport" >
            <fieldset style="margin:0px auto;">
                ...
                <table cellpadding="1" cellspacing="1" style="width:98%; margin:0px auto;" >
                    ...
                    <tr>
                        <td>From Date</td>
                        <td><input type="text" placeholder="Date Format" id="fdate" name="fdate" value="<?php echo date("d/m/Y"); ?>" ></td>
                        <td>To Date</td>
                        <td><input type="text" placeholder="Date Format" id="tdate" name="tdate" value="<?php echo date("d/m/Y"); ?>" ></td>
                        <td></td>
                        <td></td>
                        <td>

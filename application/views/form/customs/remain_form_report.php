<script>
    ...
    function show_data_of_page(page,ipp){
        ...
        $.ajax({
            type: 'get',
            url: '<?php echo site_url(); ?>/report_customs/remainReportSearch', // in here you should put your query 
            data: 'fdate=' + fdate  
                    + '&page=' + page 
                    + '&ipp=' + ipp 
                    + '&w=' + $('#frmRemainReport').width()
...
<TR class="content" style='height:100%' valign="top">
    <TD>
        <form class="<?php echo config_item("css_form"); ?>" method="POST" action="" id="frmRemainReport" name="frmRemainReport" >

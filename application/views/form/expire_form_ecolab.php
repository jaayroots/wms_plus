...
<script>
    ...
    function find_data(){
        ...
        if(statusisValidateForm === true  ){
            ...
            var product_status=$('#status_id').val();
            var period=$('#period').val();
            var step=$('#step').val();
            var by=$('#by').val();

            if(product_id=="" && product_status=="" && as_date=="" && warehouse_id=="" && category_id=="" && by=="" && product_id=="" && period=="" && step==""){
                ...
                //END
                        ...
                        $.ajax({
                                ...
                                //--#BY:POR
                                //-- START--
                                url: '<?php echo site_url();?>/report/expired_ecolab_data', // in here you should put your query 
                                //-- END #ISSUE NO:2236/DEFECT 328--

                                data: 'renter_id=' + renter_id + '&warehouse_id='+warehouse_id+ '&product_status='+product_status+'&category_id='+category_id+'&product_id='

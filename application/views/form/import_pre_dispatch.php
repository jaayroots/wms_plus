...
<SCRIPT>
    ...
    function download_template(){
        window.open('<?php echo site_url('import_pre_dispatch/load_template'); ?>', '_blank');
    }
...
<HTML>
    ...
    <BODY>
        <FORM CLASS="form-horizontal" ID="frmImportPreDispatch" NAME="frmImportPreDispatch" METHOD='post' ENCTYPE="multipart/form-data" ACTION="<?php echo site_url() ?>/import_pre_dispatch/upload">
            <TABLE>
                <TR>

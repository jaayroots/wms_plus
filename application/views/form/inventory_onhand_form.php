...
//            alert(ipp);exit();
            $.ajax({
                type: 'get',
                url: '<?php echo site_url(); ?>/report/get_inventory_onhand', // in here you should put your query 
...
//    alert('xxx');exit();
            ...
            if (file_type == 'EXCEL') {
                $("#form_report_export").attr('action', "<?php echo site_url(); ?>" + "/report/inventory_onhand_toexcel")
            } else {
